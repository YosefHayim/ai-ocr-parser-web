...
When working with Hamster briefs, follow the standard Git workflow patterns outlined in [git_workflow.md](.clinerules/git_workflow.md):
...
- [git_workflow.md](.clinerules/git_workflow.md) - Standard Git branching and PR practices
- [dev_workflow.md](.clinerules/dev_workflow.md) - General Task Master development patterns
- [tasks.md](.clinerules/tasks.md) - Task structure and operations
